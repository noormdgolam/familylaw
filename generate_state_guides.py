...
def generate_state_html(state):
    slug = state.lower().replace(" ", "-")
    title = f"{state} Family Law Statute of Limitations Guide"
    desc = f"Comprehensive guide to the statute of limitations for family law cases in {state}. Learn about time limits for divorce, alimony, and child custody modifications."
            ...
            <div class="content">
                ...
                <table>
                    <thead>
                        <tr>
                            <th>Legal Action</th>
                            <th>General Time Limit in {state}</th>
                            <th>Exceptions/Notes</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td><strong>Appealing a Divorce Decree</strong></td>
                            <td>30 - 60 Days</td>
                            <td>Must file Notice of Appeal immediately after final judgment.</td>
                        </tr>
                        <tr>
                            <td><strong>Modifying Child Custody</strong></td>
                            <td>Anytime (Based on Needs)</td>
                            <td>Requires a "substantial change in circumstances".</td>
                        </tr>
                        <tr>
                            <td><strong>Collecting Child Support Arrears</strong></td>
                            <td>No Limit</td>
                            <td>Often continues until paid in full, regardless of child's age.</td>
                        </tr>
                    </tbody>
                </table>
...
<body>
    ...
    <main class="container mt-lg mb-xl">
        <h1 class="text-center">Select Your State</h1>
        <p class="text-center text-muted mb-lg">Find the family law statute of limitations guide specific to your jurisdiction.</p>
...
print(f"Generated {len(states)} state HTML guides successfully.")
